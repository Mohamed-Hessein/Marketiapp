...
import 'package:app/Features/Auth/Persention/view/Screen/forgot_password/forgot_password_by_emailbody.dart';
...
class Forgotpasswordbyemail extends StatelessWidget {
  const Forgotpasswordbyemail({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Forgotpasswordbyemailbody(),
    );
  }
}
